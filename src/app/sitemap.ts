...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = [
    ...
    // Legal pages - noindex but included in sitemap for completeness
    ...
    { url: `${BASE_URL}/cookie-policy`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.3 },
    { url: `${BASE_URL}/refund-policy`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.3 },
