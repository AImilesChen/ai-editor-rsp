      ...
      <main className="rsp-container py-14 md:py-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-rsp-muted">
            AI Editor RSP publicly lists the third-party AI image model routes currently used for generation and editing. Prompt-based generation requests are screened by Creem Moderation API before any model call.
          </p>
        </div>
