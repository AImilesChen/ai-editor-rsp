        ...
        <div className="max-w-[760px] mx-auto">
          ...
          <div className="prose prose-neutral max-w-none text-neutral-700 leading-7">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-4">
              ...
              <li><strong>AI model and safety providers:</strong> fal.ai processes prompts, uploaded input images, and generation requests for the model routes disclosed on our <a className="text-brand-500 underline" href="/ai-models">AI Models Used</a> page. Creem Moderation API screens prompt-based image generation requests before generation for policy compliance and abuse prevention.</li>
