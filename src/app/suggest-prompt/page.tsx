...
export const metadata: Metadata = createMetadata({
  title: "Find Matching Prompts for Your Photo",
  description:
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-[1fr_420px]">
            <div className="rounded-2xl border border-neutral-300 bg-white/90 p-6 shadow-lg">
              ...
              <div className="mt-6 rounded-xl bg-warning-bg p-4 text-sm text-neutral-800">
                RSP Hub does not upload, analyze, store, or process photos. This page only collects feature interest and content requests. No AI generation happens on this site.
              </div>
