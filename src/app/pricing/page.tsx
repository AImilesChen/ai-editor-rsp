...
const pricingFaq = [
  ...
  ["Can I get a refund?", "Refunds are available within 14 days of purchase if no more than 50% of granted credits have been used. Submit the request directly from Account → Billing → Request refund."],
