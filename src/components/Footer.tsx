    ...
    <footer className="border-t border-rsp-border bg-rsp-surface px-4 py-12 text-rsp-muted md:px-12">
      <div className="mx-auto grid max-w-screen-2xl gap-10 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
        ...
        <div>
          ...
          <p className="mt-3 text-xs leading-5">Refunds available within 14 days if no more than 50% of credits have been used. Submit directly from Account → Billing → Request Refund.</p>
        </div>
      </div>
