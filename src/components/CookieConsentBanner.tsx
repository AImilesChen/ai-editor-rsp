...
export default function CookieConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[100] px-3 pb-3 sm:inset-x-auto sm:bottom-5 sm:right-5 sm:left-auto sm:top-auto sm:px-0 sm:pb-0" role="region" aria-label="Cookie consent">
