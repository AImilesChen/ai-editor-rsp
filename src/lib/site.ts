...
export const pricingPlans = [
  ...
  },
  {
    ...
    features: ["100 credits/month", "Use ready-made prompts", "Generate portraits, products, and social visuals", "Secure hosted checkout"],
  },
  {
    name: "Creator",
    price: "USD $14.99",
    cadence: "/mo",
    quota: "240 credits/month",
...
export const legalDisclaimer = "Images are generated through third-party AI model providers. Upload only images you have rights to use. Usage rights and limitations may depend on provider and model terms. Eligible refund requests can be submitted within 7 days if no more than 20% of paid credits from that billing period have been used; completion requires review and Stripe confirmation.";
