export const site = {
  ...
  description:
    "Browse RSP editing prompts and mock up AI image generations in one dark cinematic creator workstation. fal.ai, Creem, login, and credits are shown as pending integrations.",
};
...
export const pricingPlans = [
  { name: "Free", price: "$0", cadence: "lifetime", generations: "3 lifetime generations", cta: "Try mock generator", featured: false },
...
export const integrationStates = [
  { label: "fal.ai image generation", state: "Mock UI only", detail: "API contract and DPA still need backend/legal confirmation." },
  ...
  { label: "Credits", state: "Soft preview", detail: "Displayed limits follow confirmed pricing; no real deduction yet." },
];
