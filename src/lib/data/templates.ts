...
export const templates: Template[] = [
  {
    ...
    preview_image: "/images/templates/v3-babuaan-phone-preview.webp",
    tutorial_steps: [
  ...
  },
  {
    ...
    preview_image: "/images/templates/v3-ankhon-phone-preview.webp",
    tutorial_steps: [
      "Open CapCut app on your phone",
      "Tap 'Use Template' button above",
      "Select your photos/videos",
  ...
  },
  {
    ...
    preview_image: "/images/templates/v3-ekdin-phone-preview.webp",
    tutorial_steps: [
      "Open CapCut app on your phone",
      "Tap 'Use Template' button above",
      "Select your photos/videos",
